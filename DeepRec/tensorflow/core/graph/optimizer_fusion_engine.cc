...
#include "tensorflow/core/graph/template_string_split_avg_base.h"
#include "tensorflow/core/graph/template_string_split_slice_base.h"
#include "tensorflow/core/graph/template_one_hot_sum.h"
#include "tensorflow/core/graph/template_string_split_to_hash_bucket.h"
...
bool OptimizeFusion(Graph* g) {
  ...
  templates.emplace_back(new TemplateStringSplitAvgBase());
  templates.emplace_back(new TemplateStringSplitSliceBase());
  templates.emplace_back(new TemplateStringSplitToHashBucket());

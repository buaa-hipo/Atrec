...
def main(tf_config=None, server=None):
    ...
    # train_file = args.data_location + '/process_data_maxlen100_0225/train_sample_0_processed.npz'
    # test_file = args.data_location + '/process_data_maxlen100_0225/test_sample_0_processed.npz'

...
IGNORED_USER_TZ_COLUMN = [
    'geohash12',
]
IGNORED_COLUMNS = IGNORED_USER_COLUMNS + IGNORED_ITEM_COLUMN + IGNORED_USER_TZ_COLUMN
...
ITEM_COLUMN = [
    'shop_id', 'item_id', 'district_id', 'shop_aoi_id',
    'shop_geohash_6', 'brand_id', 'category_1_id',
...
SHARE_EMBEDDING_COLS = [x for x in SHARE_EMBEDDING_COLS if x[0] not in IGNORED_COLUMNS and x[1] not in IGNORED_COLUMNS] # ign col
...
CONTINUOUS_COLUMNS = [x for x in CONTINUOUS_COLUMNS if x not in IGNORED_COLUMNS] # ign col
...
def main(tf_config=None, server=None):
    ...
    # print(no_of_test_examples)
    # no_of_training_examples = 2000000
    # no_of_test_examples = 500000
